...
pub fn draw(f: &mut Frame, app: &App) {
    ...
    let lines: Vec<Line> = vec![
        ...
        shortcut("Tab / Shift+Tab", "Next / previous repo tab (on dashboard)", key_style, desc_style),
        ...
        shortcut("1", "Description section", key_style, desc_style),
        shortcut("2", "Checks section", key_style, desc_style),
        shortcut("3", "Reviews section", key_style, desc_style),
        shortcut("4", "Files section", key_style, desc_style),
        shortcut("5", "Comments section", key_style, desc_style),
        shortcut("Tab / Shift+Tab", "Cycle to next / previous section", key_style, desc_style),
        shortcut("j / k / d / u / g / G", "Scroll right pane", key_style, desc_style),
        Line::from(""),
