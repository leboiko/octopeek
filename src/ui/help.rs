...
pub fn draw(f: &mut Frame, app: &App) {
    ...
    let lines: Vec<Line> = vec![
        ...
        shortcut("[ / ]", "Previous / next repo tab", key_style, desc_style),
        ...
        shortcut("C / ^ / ˆ", "Commits section", key_style, desc_style),
        ...
        shortcut(
            "Enter (in Commits)",
            "Scope Files / Comments to selected commit",
            key_style,
            desc_style,
        ),
        shortcut("H", "Return scoped commit view to HEAD", key_style, desc_style),
        shortcut("Down / Up (Files)", "Next / previous file in overview", key_style, desc_style),
        shortcut("J / K (Files)", "Next / previous file in diff view", key_style, desc_style),
        shortcut(
            "t (in Files diff)",
        ...
        shortcut("M", "Merge PR with a merge commit", key_style, desc_style),
        shortcut("S", "Squash and merge PR", key_style, desc_style),
        shortcut("A", "Add a top-level PR / issue comment", key_style, desc_style),
        shortcut("R", "Reply to the focused review thread", key_style, desc_style),
        shortcut("Ctrl+S", "Submit from the comment composer", key_style, desc_style),
        Line::from(""),
